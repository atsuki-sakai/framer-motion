...
const Header = () => {
  ...
  return (
    <div className='p-4 absolute top-0 left-0 right-0 flex items-center justify-between'>
        ...
        <motion.div initial={{ opacity:0, x: 0, rotate: 0 }} animate={{ opacity:1, x: showMenu ? 600 : 0, rotate: showMenu ? 90 : 0 }} transition={{ duration:0.5 }} className='absolute top-0 left-0 right-0  h-screen max-w-xl bg-red-500'>
