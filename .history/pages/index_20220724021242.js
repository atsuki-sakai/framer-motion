...
export default function Home() {
  ...
  return (
    <div className="relative h-screen w-full bg-gray-300">
      ...
      <motion.div initial={{width:120 }} animate={{ width: show ? 120 : 320 }} transition={{ duration:0.5 }} className="absolute top-0 left-0 w-[120px] md:w-full h-full md:h-[50px] bg-white">
