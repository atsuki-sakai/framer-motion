  ...
  return (
    <div>
      <div className="h-screen w-screen bg-red-200 flex justify-center items-center">
          <motion.div whileHover={{ backgroundColor: "#590000" }} className="w-full h-screen text-white rounded-md" initial={{rotate:-90, opacity:0}} animate={{ backgroundColor: rotate ? "#11FF00" : "#FF0000", x: rotate ? 220 : 0 , scale: rotate ? 0.25 : 1, opacity:1 }} onClick={() => {setRotate(!rotate)}}>
          </motion.div>
      </div>
