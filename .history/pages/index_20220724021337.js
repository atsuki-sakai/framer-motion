...
export default function Home() {
  ...
  return (
    <div className="relative h-screen w-full bg-gray-300">
      ...
      <motion.div initial={{scaleX: 0.25 }} animate={{ scaleX: show ? 0.25 : 1 }} transition={{ duration:0.5 }} className="absolute top-0 left-0 w-[120px] md:w-full h-full md:h-[50px] bg-white">
        <div className="flex  justify-center h-full w-full">
          <motion.div animate={{ opacity: show ? 1 : 0 }} transition={{ duration:0.5 }} className="text-xl">
            <div className="absolute right-0 top-0 w-[120px] md:w-full h-full md:h-[24px] py-12 md:flex md:items-center">
              <p className="text-center font-bold text-4xl">b</p>
              <p className="text-center font-bold text-4xl">y</p>
              <p className="text-center font-bold text-4xl">t</p>
              <p className="text-center font-bold text-4xl">e</p>
            </div>
          </motion.div>
